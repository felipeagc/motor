...
static VkFormat mt_format_to_vulkan(MtFormat format) {
  switch (format) {
...
static MtIndexType mt_index_type_from_vulkan(VkIndexType index_type) {
  switch (index_type) {
...
static VkIndexType mt_index_type_to_vulkan(MtIndexType index_type) {
  switch (index_type) {
...
static MtCullMode mt_cull_mode_from_vulkan(VkCullModeFlagBits cull_mode) {
  switch (cull_mode) {
...
static VkCullModeFlagBits mt_cull_mode_to_vulkan(MtCullMode cull_mode) {
  switch (cull_mode) {
...
static MtFrontFace mt_front_face_from_vulkan(VkFrontFace front_face) {
  switch (front_face) {
...
static VkFrontFace mt_front_face_to_vulkan(MtFrontFace front_face) {
  switch (front_face) {

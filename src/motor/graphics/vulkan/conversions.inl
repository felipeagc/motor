...
static MtSamplerAddressMode sampler_address_mode_from_vulkan(VkSamplerAddressMode value)
{
    switch (value)
    {
        ...
        case VK_SAMPLER_ADDRESS_MODE_CLAMP_TO_EDGE: return MT_SAMPLER_ADDRESS_MODE_CLAMP_TO_EDGE;
...
static MtBorderColor border_color_from_vulkan(VkBorderColor value)
{
    switch (value)
    {
        ...
        case VK_BORDER_COLOR_INT_TRANSPARENT_BLACK: return MT_BORDER_COLOR_INT_TRANSPARENT_BLACK;
        case VK_BORDER_COLOR_FLOAT_OPAQUE_BLACK: return MT_BORDER_COLOR_FLOAT_OPAQUE_BLACK;
        case VK_BORDER_COLOR_INT_OPAQUE_BLACK: return MT_BORDER_COLOR_INT_OPAQUE_BLACK;
        case VK_BORDER_COLOR_FLOAT_OPAQUE_WHITE: return MT_BORDER_COLOR_FLOAT_OPAQUE_WHITE;
        case VK_BORDER_COLOR_INT_OPAQUE_WHITE: return MT_BORDER_COLOR_INT_OPAQUE_WHITE;
        default: assert(0);
    }
}
